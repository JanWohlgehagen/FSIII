...
(
    ...
    CONSTRAINT FK_Borger_IDCD FOREIGN KEY (Case_ID, Borger_ID) REFERENCES [Case](ID,Borger_ID),
...
(
    ...
    CONSTRAINT FK_Borger_IDGO FOREIGN KEY (Borger_ID) REFERENCES Borger(ID)
...
(
    ...
    CONSTRAINT FK_Borger_IDHS FOREIGN KEY (Borger_ID) REFERENCES Borger(ID)
)
...
(
    ...
    CONSTRAINT FK_HS_IDHSV FOREIGN KEY (HS_ID,HS_Borger_ID) REFERENCES Helbredstilstand(ID,Borger_ID),
...
(
    ...
    CONSTRAINT FK_Borger_IDFS FOREIGN KEY (Borger_ID) REFERENCES Borger(ID)
)
...
(
    ...
    CONSTRAINT FK_HS_IDFSV FOREIGN KEY (FS_ID, FS_Borger_ID) REFERENCES Funktionstilstand(ID,Borger_ID),
